{ pkgs, ... }:
{
  ...
  home.file.".config/swaync/style.css" = {
    ...
    force = true;
    text = ''
      @define-color cc-bg rgba(22, 22, 22, 0.9);
      @define-color noti-border-color rgba(255, 255, 255, 0.15);
      @define-color noti-bg rgba(22, 22, 22, 0.8);
      ...
      @define-color bg-selected rgb(120, 169, 255);
  ...
  home.file.".config/swaync/config.json" = {
    ...
    text = ''
      {
        "$schema": "~/.nix-profile/etc/xdg/swaync/configSchema.json",
        "positionX": "right",
        "positionY": "top",
        "layer": "overlay",
